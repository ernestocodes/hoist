...
console.log(food);
// var mean
// mean(); //will error because mean is not yet = to a function
// console.log(food); //will error because there is no food variable
// mean = function() {
//     var food;
//     food = "chicken";
//     console.log(food);
...
// console.log(makeDojo("Berkeley", 0)); dojo is const thus error will occur when dojo tries to get reassigned